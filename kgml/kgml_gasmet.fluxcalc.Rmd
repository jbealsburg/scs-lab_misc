...
Converting ch4 concentrations (ppm n2o) to ug N/cm3.

The equation is = (element mass/ambient pressure) \* (1/1000000) \* (1/0.082057) \* (1/273.15 + chamber temp) \* 1000

Then create a new dataframe, which selects a subset of columns, creates a unique ID column 'code', and uses the created function to convert to ch4.c using ch4 and cell temp columns.
...
Convert slope value to ch4 equivalents. Then use chamber height to remove 3rd dimension–leaving a value of rate of ch4 respiration per unit area (ug/cm2/s). Two conversions are made to relevant units, including g/m2/day and kg/ha/yr.
